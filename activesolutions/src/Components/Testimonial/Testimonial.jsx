...
const trex = require("../Styles/img/trex.jpg");
const matias = require("../Styles/img/mati.jpg");
const luca = require("../Styles/img/luca.jpg");
const black = require("../Styles/img/black.jpg");
const Testimonials = () => {
        ...
        <div className="container">
            ...
            <div>
                <div className="testimonial-item text-center">
                    <img className="bg-light rounded-circle p-2 mx-auto mb-3" src={black} style={{width: '80px', height: '80px'}}/>
                ...
                <div className="testimonial-item text-center">
                    <img className="bg-light rounded-circle p-2 mx-auto mb-3" src={matias} style={{width: '80px', height: '80px'}}/>
                ...
                <div className="testimonial-item text-center">
                    <img className="bg-light rounded-circle p-2 mx-auto mb-3" src={luca} style={{width: '80px', height: '80px'}}/>
                ...
                <div className="testimonial-item text-center">
                    <img className="bg-light rounded-circle p-2 mx-auto mb-3" src={trex} style={{width: '80px', height: '80px'}}/>
